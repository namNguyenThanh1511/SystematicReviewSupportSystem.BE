...
namespace SRSS.IAM.API.Data
{
	public static class DbInitializer
	{
        ...
        private static async Task SeedDataSynthesisAsync(AppDbContext context)
        {
			...
			{
				await context.DataSynthesisStrategies.AddAsync(new DataSynthesisStrategy { Id = Har2SynthesisStrategy1Id, ProtocolId = HarProtocol2Id, SynthesisType = "Narrative synthesis for Protocol 2", Description = "Narrative synthesis of recent HAR advancements", CreatedAt = DateTimeOffset.UtcNow, ModifiedAt = DateTimeOffset.UtcNow });
				await context.SaveChangesAsync();
			}
