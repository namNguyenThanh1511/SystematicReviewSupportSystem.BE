...
namespace SRSS.IAM.Repositories
{
	public class AppDbContext : DbContext
	{
		...
		// DATA EXTRACTION (CONDUCTING PHASE)
		public DbSet<ExtractionContext> ExtractionContexts { get; set; } = default!;
		public DbSet<ExtractionStudyAssignment> ExtractionStudyAssignments { get; set; } = default!;
		public DbSet<ExtractionDraft> ExtractionDrafts { get; set; } = default!;
		public DbSet<ExtractionSubmission> ExtractionSubmissions { get; set; } = default!;
		public DbSet<ExtractionAnswer> ExtractionAnswers { get; set; } = default!;
		public DbSet<ExtractionConflict> ExtractionConflicts { get; set; } = default!;
		public DbSet<ExtractionResolution> ExtractionResolutions { get; set; } = default!;
	}
}
