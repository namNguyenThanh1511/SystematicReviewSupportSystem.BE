...
namespace SRSS.IAM.Repositories.Migrations
{
    ...
    [Migration("20260327164337_AddProjectSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SRSS.IAM.Repositories.Entities.ProjectSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AutoResolveDuplicates")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_resolve_duplicates");

                    b.Property<bool>("AutoResolveExtractionConflicts")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_resolve_extraction_conflicts");

                    b.Property<bool>("AutoResolveQualityConflicts")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_resolve_quality_conflicts");

                    b.Property<bool>("AutoResolveScreeningConflicts")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_resolve_screening_conflicts");

                    b.Property<DateTimeOffset>("CreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at");

                    b.Property<string>("DeduplicationStrictness")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("deduplication_strictness");
                    ...
                    b.Property<int>("ReviewersPerPaperExtraction")
                        .HasColumnType("integer")
                        .HasColumnName("reviewers_per_paper_extraction");

                    b.Property<int>("ReviewersPerPaperQuality")
                        .HasColumnType("integer")
                        .HasColumnName("reviewers_per_paper_quality");

                    b.Property<int>("ReviewersPerPaperScreening")
                        .HasColumnType("integer")
                        .HasColumnName("reviewers_per_paper_screening");
            ...
            modelBuilder.Entity("SRSS.IAM.Repositories.Entities.ProjectSetting", b =>
                {
                    b.HasOne("SRSS.IAM.Repositories.Entities.SystematicReviewProject", "Project")
                        ...
                        .HasForeignKey("SRSS.IAM.Repositories.Entities.ProjectSetting", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
