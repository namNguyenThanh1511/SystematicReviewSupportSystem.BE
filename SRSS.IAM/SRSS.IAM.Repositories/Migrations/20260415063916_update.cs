        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "text", nullable: true),
                    target_research_question_ids = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    data_grouping_plan = table.Column<string>(type: "text", nullable: true),
                    sensitivity_analysis_plan = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    protocol_id = table.Column<Guid>(type: "uuid", nullable: false),
                    master_source_id = table.Column<Guid>(type: "uuid", nullable: true),
                    name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    modified_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_search_source", x => x.id);
                    table.ForeignKey(
                        name: "FK_search_source_master_search_sources_master_source_id",
                        column: x => x.master_source_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentFileHash = table.Column<string>(type: "text", nullable: true),
                    ...
                    full_text_retrieval_status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    embedding_provider = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_paper_chunks", x => x.id);
                    table.ForeignKey(
                        name: "FK_paper_chunks_papers_paper_id",
                        column: x => x.paper_id,
                        principalTable: "papers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractionQuality = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedFields = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    exclusion_reason_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.exclusion_reason_id,
            ...
            migrationBuilder.CreateTable(
                name: "study_selection_ai_results",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    study_selection_process_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    reviewer_id = table.Column<Guid>(type: "uuid", nullable: false),
                    screening_phase = table.Column<string>(type: "text", nullable: false),
                    ai_output_json = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_study_selection_ai_results", x => x.id);
                    table.ForeignKey(
                        name: "FK_study_selection_ai_results_papers_paper_id",
                        column: x => x.paper_id,
                        principalTable: "papers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_study_selection_ai_results_study_selection_processes_study_~",
                        column: x => x.study_selection_process_id,
                        principalTable: "study_selection_processes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_study_selection_ai_results_users_reviewer_id",
                        column: x => x.reviewer_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    publication_year = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    doi = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    RawReference = table.Column<string>(type: "text", nullable: true),
                    NormalizedReference = table.Column<string>(type: "text", nullable: true),
                    confidence_score = table.Column<decimal>(type: "numeric", nullable: false),
                    ExtractionQualityScore = table.Column<decimal>(type: "numeric", nullable: false),
                    MatchConfidenceScore = table.Column<decimal>(type: "numeric", nullable: false),
                    ReferenceType = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    TargetPaperId = table.Column<Guid>(type: "uuid", nullable: true),
                    CitationId = table.Column<Guid>(type: "uuid", nullable: true),
                    IsSelectedInScreening = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    comment = table.Column<string>(type: "text", nullable: true),
                    pdf_highlight_coordinates = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    modified_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_paper_chunks_embedding",
                table: "paper_chunks",
                column: "embedding")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_study_selection_ai_results_paper_id",
                table: "study_selection_ai_results",
                column: "paper_id");

            migrationBuilder.CreateIndex(
                name: "IX_study_selection_ai_results_reviewer_id",
                table: "study_selection_ai_results",
                column: "reviewer_id");

            migrationBuilder.CreateIndex(
                name: "uq_ss_ai_results_process_paper_reviewer_phase",
                table: "study_selection_ai_results",
                columns: new[] { "study_selection_process_id", "paper_id", "reviewer_id", "screening_phase" },
                unique: true);
